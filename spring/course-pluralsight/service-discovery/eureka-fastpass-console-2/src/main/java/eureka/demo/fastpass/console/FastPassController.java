...
@RibbonClient(name="spring-cloud-coordinating-fastpass-service-local")
//		, configuration=TollClientRoutingConfig.class)
@Controller
...
//	@HystrixCommand(fallbackMethod="getFastPassCustomerDetailsBackup")
	...
	public String getFastPassCustomerDetails(@RequestParam String fastpassid, Model m) {
		...
		FastPassCustomer c = restTemplate.getForObject("http://spring-cloud-coordinating-fastpass-service/fastpass?fastpassid=" + fastpassid, FastPassCustomer.class);
