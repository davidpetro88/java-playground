...
public class App {
     ...
     * whole high level implementation as well For example: connectMySQL to Oracle
    ...
    public static void main(String[] args) {
        ...
        databaseHandler.connectMySQL();
        databaseHandler.disconnectMySQL();
        databaseHandler.connectOracle();
        databaseHandler.disconnectOracle();
    }
}
