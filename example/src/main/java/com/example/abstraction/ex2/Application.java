...
//        String stringData = "Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
    ...
    while (root != null) {
      Object nextValue = root.next() != null ? root.next().value : null;
      Object previousValue = root.previous() != null ? root.previous().value : null;
      System.out.println("Value : " + root.value + " Next : " + nextValue + " previous : " + previousValue);
      root = root.next();
    }
