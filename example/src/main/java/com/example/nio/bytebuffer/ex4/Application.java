package com.example.nio.bytebuffer.ex4;
...
//            bytebuffer(ByteBuffer) - the same as read, except it writes. There's one exception.
//                              If a datasource is opened in APPEND mode, then the first bytebuffer will take place starting
//                              at the end of the datasource, rather than at position 0. After the bytebuffer, the position
