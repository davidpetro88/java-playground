...
public class Application {
    public static void main(String[] args) {
        ...
        Hamburger hamburger = new Hamburger("Basic", "Sausage", 3.56, "White", 4);
        hamburger.addAdditional("Tomato", 0.27);
        hamburger.addAdditional("Lettuce", 0.75);
        hamburger.addAdditional("Cheese", 1.13);
        hamburger.addAdditional("Egg", 1.0);
        hamburger.addAdditional("One more", 1.13);
        System.out.println("Total Burger price is " + hamburger.itemizeHamburger());

        HealthyBurger healthyBurger = new HealthyBurger("Bacon", 5.67);
        healthyBurger.addAdditional("Egg", 5.43);
        healthyBurger.addAdditional("Lentils", 3.41);
        System.out.println("Total Healthy Burger price is  " + healthyBurger.itemizeHamburger());

        DeluxeBurger db = new DeluxeBurger();
        db.addAdditional("Should not do this", 50.53);
        db.itemizeHamburger();
    }
}